...
pub fn depth_ordered_draw(
    ...
    let _scope = ProfileScope::new(
        &*profiling,
        "systems::base::depth_ordered_draw::depth_ordered_draw",
        &["render", "depth", "sorting", "draw"],
    );

    for (mut transform, layer) in &mut query {
        transform.translation.z =
            layer.depth_value() - transform.translation.y / f32::MAX;
    }
}
...
pub fn depth_ordered_draw_once(
    ...
    let _scope = ProfileScope::new(
        &*profiling,
        "systems::base::depth_ordered_draw::depth_ordered_draw_once",
        &["render", "depth", "sorting", "draw", "startup"],
    );

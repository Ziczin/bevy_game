...
pub fn rebuild_nav_grid(
    ...
    profile_scope!(profiling, "core::navigation::grid_builder::rebuild_nav_grid", &["pathfinding", "navgrid", "setup", "spatial_query"]);
...
pub fn build_initial_nav_grid(
    ...
    profile_scope!(&profiling, "core::navigation::grid_builder::build_initial_nav_grid", &["pathfinding", "navgrid", "setup", "spawn"]);
    debug_log!(&mut debug_log, &["setup", "pathfinding"], "build_initial_nav_grid: Starting...");
    let Ok(player_transform) = player_query.single() else {
        debug_log!(&mut debug_log, &["pathfinding"], "build_initial_nav_grid: Player not found in PostStartup!");
        return;
    };
    ...
    debug_log!(&mut debug_log, &["pathfinding"], "build_initial_nav_grid: Player found at ({:.1}, {:.1})", player_pos.x, player_pos.y);
    ...
    debug_log!(&mut debug_log, &["pathfinding"], "NavGrid built: {}x{} cells. Walkable: {}, Blocked: {}", grid_width, grid_height, walkable, blocked);
}
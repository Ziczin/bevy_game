...
const DEBUG_NAVMESH_POINTS: bool = false;
#[cfg(not(debug_assertions))]
const DEBUG_NAVMESH_PATHS: bool = false;
#[cfg(not(debug_assertions))]
const DEBUG_NAVMESH_AGENTS: bool = false;
#[cfg(not(debug_assertions))]
...
fn main() {
    ...
    #[cfg(debug_assertions)]
    {
        ...
        app.insert_resource(core::debug_log::DebugLogBuffer {
        ...
        app.insert_resource(core::profiling::ProfilingBuffer {
        ...
        app.add_systems(First, core::profiling::update_frame_start)
           .add_systems(Update, (

...
fn get_tile_rotation(x: usize, y: usize) -> Quat {
    ...
    return Quat::from_rotation_z(seed * std::f32::consts::FRAC_PI_2);
}
...
pub fn spawn_ground(
    ...
    let _scope = ProfileScope::new(&profiling, "entities::playground::spawn_ground::spawn_ground", &["playground", "setup", "spawn", "tile", "ground"]);
